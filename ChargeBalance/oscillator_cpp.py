...
def Pertrubation(dkick):
    return _oscillator_cpp.Pertrubation(dkick)
Pertrubation = _oscillator_cpp.Pertrubation

def Rectangular_signal(dkick, skip_parameter):
    return _oscillator_cpp.Rectangular_signal(dkick, skip_parameter)
Rectangular_signal = _oscillator_cpp.Rectangular_signal

def Charge_balance_signal(dkick, amplitude, skip_parameter):
    return _oscillator_cpp.Charge_balance_signal(dkick, amplitude, skip_parameter)
Charge_balance_signal = _oscillator_cpp.Charge_balance_signal

def change_epsilon(epsilon_val):
    return _oscillator_cpp.change_epsilon(epsilon_val)
change_epsilon = _oscillator_cpp.change_epsilon

def Make_step():
    return _oscillator_cpp.Make_step()
...
def Calc_mfx():
    return _oscillator_cpp.Calc_mfx()
Calc_mfx = _oscillator_cpp.Calc_mfx

def Calc_mfy():
    return _oscillator_cpp.Calc_mfy()
