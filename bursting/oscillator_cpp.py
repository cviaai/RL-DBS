...
def ensem(t, y, ydot):
    return _oscillator_cpp.ensem(t, y, ydot)
ensem = _oscillator_cpp.ensem
...
def init(nosc_, epsilon_, frrms_, sdim_):
    return _oscillator_cpp.init(nosc_, epsilon_, frrms_, sdim_)
...
def get_one(y, indx):
    return _oscillator_cpp.get_one(y, indx)
get_one = _oscillator_cpp.get_one
